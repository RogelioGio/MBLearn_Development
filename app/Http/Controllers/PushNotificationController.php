...
{
    public function sendResetPasswordReq(Request $request, MailComponent $mailComponent)
    {
        // Validate input
        $request->validate([
        ...
        $htmlBody = "<h1>Password Reset</h1><p>Click to reset your password.</p>";
        ...
        if ($result) {
            ...
            return response()->json(['error' => 'Failed to send reset password email.'], 500);
        }
