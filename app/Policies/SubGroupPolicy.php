...
class SubGroupPolicy
{
     ...
     */
    public function update(UserCredentials $userCredentials, SubGroup $subGroup): bool
    {
        return false;
    }
     ...
     */
    public function delete(UserCredentials $userCredentials, SubGroup $subGroup): bool
    {
        return false;
    }
