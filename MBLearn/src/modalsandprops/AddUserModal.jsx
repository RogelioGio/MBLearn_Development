                    ...
                    <DialogPanel transition className='relative overflow-hidden transform rounded-md bg-white text-left shadow-xl transition-all data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in'>
                        <div className='bg-white rounded-md h-full w-fit p-5 flex flex-col'>
                            ...
                            <div className="mx-4 flex flex-row gap-5">
                                <form action="#" method="post" className="grid grid-cols-3 gap-y-2 ">
                                {/* User information */}
                                ...
                                <div className="inline-flex flex-col gap-2 row-start-2 col-span-3">
                                    ...
                                    <input type="text" name="Name" className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
                                {/* Employee Details */}
                                <div className="inline-flex flex-col gap-2 row-start-3 col-span-1 pr-2">
                                    ...
                                    <input type="text" name="EmployeeID" className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
                                <div className="inline-flex flex-col gap-2 row-start-3 col-span-1 pr-2">
                                    {/* Must be dropdown */}
                                    <label htmlFor="Department" className="font-header text-xs uppercase ">Deparment:</label>
                                    <input type="text" name="Department" className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
                                <div className="inline-flex flex-col gap-2 row-start-3 col-span-1">
                                    ...
                                    <input type="text" name="Title" className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
                                <div className="inline-flex flex-col gap-2 row-start-4 col-span-2 pr-2">
                                    ...
                                    <input type="text" name="Branch"className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
                                <div className="inline-flex flex-col gap-2 row-start-4 col-span-1 pb-4">
                                    ...
                                    <input type="text" name="City" className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
                                {/* Account credentials */}
                                ...
                                <div className="inline-flex flex-col gap-2 row-start-6 col-span-2 pr-2">
                                    ...
                                    <input type="text" name="Email" className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
                                <div className="inline-flex flex-col gap-2 row-start-6 col-span-2 pb-4">
                                    ...
                                    <input type="text" name="Password" className="border border-divider rounded-md p-2 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-primary"/>
                                </div>
