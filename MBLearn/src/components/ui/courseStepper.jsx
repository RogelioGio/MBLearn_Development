        ...
        >
            {
                ...
                <>
                {/* Learner */}
                <div className="grid-rows-[min-content_1fr] grid-cols-4 h-full
                                lg:grid flex flex-col">
                    {/* Header */}
                    <div className="border-b border-divider col-span-3 flex-row items-center justify-between py-2 pr-4 lg:flex hidden">
                    ...
                    {/* Steps */}
                    <div className="py-2 pl-4 mr-3 flex-row gap-2 items-center border-divider border-b border-l lg:flex hidden">
                        {
                            isLoading ?
                            <div className="flex flex-row gap-2 animate-pulse">
                                <RingProgress
                    ...
                    <div className="col-start-4 pl-4 mr-3 border-l border-divider hidden lg:block">
