    ...
    return(
        ...
        <div className='col-span-3 row-start-3 mr-5 pt-2 pb-5'>
            <div className="flex flex-col w-full h-full gap-2">
                ...
                {
                    <div className="w-full h-full grid grid-cols-1 grid-rows-3 gap-y-2">
                        <div className="w-full h-full bg-white border-2 border-primary rounded-md shadow-md p-3 flex flex-row  justify-start items-center gap-3 hover:cursor-pointer hover:bg-primary group transition-all ease-in-out"
                            onClick={() => navigate('/learner/learnercoursemanager/enrolled')}>
                            {/* icon */}
                            <div className="group-hover:text-white group-hover:bg-gray-50 group-hover:bg-opacity-20  text-primary flex flex-col item-center justify-center bg-primarybg p-3 aspect-square rounded-full">
