...
import { faFolderPlus, faSearch, faArrowDownWideShort, faPlus, faMinus, faChevronUp, faChevronDown, faPenToSquare, faTrash, faChevronLeft, faChevronRight } from '@fortawesome/free-solid-svg-icons'
...
export default function CourseListMaintenance() {
    return (
        <div className='grid  grid-cols-4 grid-rows-[6.25rem_auto] h-full w-full'>
            ...
            <div className='row-start-3 row-span-3 col-start-1 col-span-3 w-full px-5 py-2 flex flex-col gap-2'>
                {
                    Courses.map((course) => (
                        // card
                        <div key={course.id} className='w-full h-fit flex flex-row rounded-md bg-white shadow-md hover:scale-105 hover:cursor-pointer transition-all ease-in-out'>
                            {/* Course Image */}
                            ...
                            <div className='p-5 w-full'>
                                ...
                                <div className='flex flex-row place-content-between items-center mb-2'>
                                    ...
                                    <div className='flex flex-row gap-2'>
                                        ...
                                        {/* Dapat matapos na yung view course tomorrow aswell kahit simpleng modal lang mwaps mwaps */}
                                    </div>
                                </div>
                                {/* Course Details */}
