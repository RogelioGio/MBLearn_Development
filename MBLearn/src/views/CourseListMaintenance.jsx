            ...
            <div className='row-start-3 row-span-3 col-start-1 col-span-3 w-full px-5 py-2 flex flex-col gap-2'>
                {
                    Courses.map((course) => (
                        // card
                        <div key={course.id} className='w-full h-fit flex flex-row rounded-md bg-white shadow-md hover:scale-105 hover:cursor-pointer transition-all ease-in-out' onClick={() => OpenDialog(course)}>
                            {/* Course Image */}
